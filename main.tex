...
\geometry{left=0mm, top=20mm, right=0mm, bottom=0mm}
...
\begin{tabularx}{\textwidth}{c@{\hskip 30px}c}
    \includegraphics[width=50mm,height=!]{OMSEFundLogo} & \includegraphics[width=50mm,height=!]{OMSEFundLogo} \\
    \textbf
    \centering
    \resizebox{0.45\textwidth}{!}{%
      \begin{tabularx}{150px}{ |Y|Y|Y|Y|Y| }
        \multicolumn{1}{c}{O} & \multicolumn{1}{c}{M} & \multicolumn{1}{c}{S} & \multicolumn{1}{c}{E} & \multicolumn{1}{c}{F} \vspace*{-0.3em} \\
        \hline
        ...
        \getIndex{arr}{3}{1} & \getIndex{arr}{3}{2} & \raisebox{-.15\height}{ \includegraphics[width=4.5mm,height=4.5mm]{QR} } & \getIndex{arr}{3}{4} & \getIndex{arr}{3}{5} \\ \hline
...
&  \
    ...
    \resizebox{0.45\textwidth}{!}{%
      \begin{tabularx}{150px}{ |Y|Y|Y|Y|Y| }
        ...
        \getIndex{arr}{8}{1} & \getIndex{arr}{8}{2} & \raisebox{-.2\height}{ \includegraphics[width=4.5mm,height=4.5mm]{QR} } & \getIndex{arr}{8}{4} & \getIndex{arr}{8}{5} \\ \hline
